...
## Build out the tests in bing.tests.test_l23_fitting.py to cover the individual methods in bing.fitting.l23.py.  If you need to run Python, use the "ocean13" environment in conda.
